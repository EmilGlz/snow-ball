...
public class UIManager : MonoBehaviour
{
    ...
    {
        TinySauce.OnGameStarted(levelNumber: CommonData.Instance.currentLevel.ToString());
        Time.timeScale = 1f;
    ...
    {
        TinySauce.OnGameFinished(false, CommonData.Instance.collectedCoins, levelNumber: CommonData.Instance.currentLevel.ToString());
