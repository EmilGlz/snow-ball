...
public class Grow : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        else if (other.CompareTag("ENDGAME"))
        {
            ...
            TinySauce.OnGameFinished(true, CommonData.Instance.collectedCoins);
    ...
    public void DIE()
    {
        TinySauce.OnGameFinished(false, CommonData.Instance.collectedCoins, levelNumber: CommonData.Instance.collectedCoins.ToString());
